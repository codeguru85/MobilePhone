...
- (BOOL)_shouldPerformSystemProvidedPresentationOfAlertController:(UIAlertController *)arg1 atSystemProvidedPresentationRegisteredViewLocation:(struct CGPoint)arg2;
@end
